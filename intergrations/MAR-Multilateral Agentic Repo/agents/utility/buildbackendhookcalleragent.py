...
class BuildBackendHookCallerAgent:
    """Agent based on BuildBackendHookCaller from ..\Nyxion\env\Lib\site-packages\pip\_vendor\pyproject_hooks\_impl.py"""
    
    def __init__(self):
        self.name = "BuildBackendHookCallerAgent"
